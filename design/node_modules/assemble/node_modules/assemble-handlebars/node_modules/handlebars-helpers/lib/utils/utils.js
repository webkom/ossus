...
var localConfig = function(filepath) {
 ...
 * Config object.
 */
var config = require('./lib/pkg.js');
if(grunt.file.exists(localConfig('package.json'))) {
  var pkg = grunt.file.readJSON(localConfig('package.json'));
  config = _.extend(require('./lib/pkg.js'), pkg);
}
