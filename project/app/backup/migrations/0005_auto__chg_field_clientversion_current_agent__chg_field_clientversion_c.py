...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ClientVersion.current_agent'
        db.alter_column('backup_clientversion', 'current_agent', self.gf('django.db.models.fields.BooleanField')(unique=True))

        # Changing field 'ClientVersion.current_updater'
        db.alter_column('backup_clientversion', 'current_updater', self.gf('django.db.models.fields.BooleanField')(unique=True))
    ...
    models = {
        ...
        'backup.clientversion': {
            ...
            'current_agent': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'current_updater': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 14, 1, 20, 439190)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 14, 1, 20, 438330)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
