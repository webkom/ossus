...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClientVersion.updater_link'
        db.delete_column('backup_clientversion', 'updater_link')

        # Deleting field 'ClientVersion.agent_link'
        db.delete_column('backup_clientversion', 'agent_link')

    def backwards(self, orm):
        # Adding field 'ClientVersion.updater_link'
        db.add_column('backup_clientversion', 'updater_link',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Adding field 'ClientVersion.agent_link'
        db.add_column('backup_clientversion', 'agent_link',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
