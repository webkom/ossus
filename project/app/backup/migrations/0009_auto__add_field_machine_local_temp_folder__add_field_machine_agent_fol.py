...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('backup_machine', 'mysql_dump',
                      self.gf('django.db.models.fields.CharField')(default='mysqldump', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.local_temp_folder'
        db.delete_column('backup_machine', 'local_temp_folder')

        # Deleting field 'Machine.agent_folder'
        db.delete_column('backup_machine', 'agent_folder')

        # Deleting field 'Machine.mysql_dump'
        db.delete_column('backup_machine', 'mysql_dump')
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
