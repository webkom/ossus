...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FolderBackup.skip_hidden_folders'
        db.add_column('backup_folderbackup', 'skip_hidden_folders', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FolderBackup.skip_hidden_folders'
        db.delete_column('backup_folderbackup', 'skip_hidden_folders')
