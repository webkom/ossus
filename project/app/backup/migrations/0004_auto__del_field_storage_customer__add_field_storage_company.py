...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Storage.customer'
        db.delete_column('backup_storage', 'customer_id')

        # Adding field 'Storage.company'
        db.add_column('backup_storage', 'company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='storages', null=True, to=orm['backup.Company']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Storage.customer'
        db.add_column('backup_storage', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='storages', null=True, to=orm['backup.Customer']), keep_default=False)

        # Deleting field 'Storage.company'
        db.delete_column('backup_storage', 'company_id')
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 21, 44, 15, 817580)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 21, 44, 15, 816816)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
