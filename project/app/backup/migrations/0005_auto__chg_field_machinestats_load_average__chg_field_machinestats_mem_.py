...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MachineStats.load_average'
        db.alter_column('backup_machinestats', 'load_average', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=3))

        # Changing field 'MachineStats.mem_free'
        db.alter_column('backup_machinestats', 'mem_free', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'MachineStats.cpu_user'
        db.alter_column('backup_machinestats', 'cpu_user', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=3))

        # Changing field 'MachineStats.cpu_system'
        db.alter_column('backup_machinestats', 'cpu_system', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=3))

        # Changing field 'MachineStats.mem_used'
        db.alter_column('backup_machinestats', 'mem_used', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'MachineStats.cpu_stolen'
        db.alter_column('backup_machinestats', 'cpu_stolen', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=3))


    def backwards(self, orm):
        
        # Changing field 'MachineStats.load_average'
        db.alter_column('backup_machinestats', 'load_average', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))

        # Changing field 'MachineStats.mem_free'
        db.alter_column('backup_machinestats', 'mem_free', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))

        # Changing field 'MachineStats.cpu_user'
        db.alter_column('backup_machinestats', 'cpu_user', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))

        # Changing field 'MachineStats.cpu_system'
        db.alter_column('backup_machinestats', 'cpu_system', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))

        # Changing field 'MachineStats.mem_used'
        db.alter_column('backup_machinestats', 'mem_used', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))

        # Changing field 'MachineStats.cpu_stolen'
        db.alter_column('backup_machinestats', 'cpu_stolen', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 2, 14, 22, 35, 507557)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 2, 14, 22, 35, 506880)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
