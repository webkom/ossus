...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientVersion.agent'
        db.add_column('backup_clientversion', 'agent',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'ClientVersion.updater'
        db.add_column('backup_clientversion', 'updater',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ClientVersion.agent'
        db.delete_column('backup_clientversion', 'agent')

        # Deleting field 'ClientVersion.updater'
        db.delete_column('backup_clientversion', 'updater')
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
