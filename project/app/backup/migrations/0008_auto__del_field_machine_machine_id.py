...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Machine.machine_id'
        db.delete_column('backup_machine', 'machine_id')


    def backwards(self, orm):
        # Adding field 'Machine.machine_id'
        db.add_column('backup_machine', 'machine_id',
    ...
    models = {
        ...
        'backup.machine': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_connection_to_client': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
