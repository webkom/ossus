...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ClientVersion', fields ['current_updater']
        db.delete_unique('backup_clientversion', ['current_updater'])

        # Removing unique constraint on 'ClientVersion', fields ['current_agent']
        db.delete_unique('backup_clientversion', ['current_agent'])

        # Changing field 'ClientVersion.current_agent'
        db.alter_column('backup_clientversion', 'current_agent', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ClientVersion.current_updater'
        db.alter_column('backup_clientversion', 'current_updater', self.gf('django.db.models.fields.BooleanField')())


    def backwards(self, orm):
        
        # Changing field 'ClientVersion.current_agent'
        db.alter_column('backup_clientversion', 'current_agent', self.gf('django.db.models.fields.NullBooleanField')(unique=True, null=True))

        # Adding unique constraint on 'ClientVersion', fields ['current_agent']
        db.create_unique('backup_clientversion', ['current_agent'])

        # Changing field 'ClientVersion.current_updater'
        db.alter_column('backup_clientversion', 'current_updater', self.gf('django.db.models.fields.NullBooleanField')(unique=True, null=True))

        # Adding unique constraint on 'ClientVersion', fields ['current_updater']
        db.create_unique('backup_clientversion', ['current_updater'])
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 14, 3, 8, 837492)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 14, 3, 8, 836640)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
