...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 10, 16, 21, 30, 125640)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 10, 16, 21, 30, 124997)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
