...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MachineStats.mem_used'
        db.add_column('backup_machinestats', 'mem_used', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3), keep_default=False)

        # Adding field 'MachineStats.mem_free'
        db.add_column('backup_machinestats', 'mem_free', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MachineStats.mem_used'
        db.delete_column('backup_machinestats', 'mem_used')

        # Deleting field 'MachineStats.mem_free'
        db.delete_column('backup_machinestats', 'mem_free')
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 2, 14, 19, 50, 643796)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 2, 14, 19, 50, 643138)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'load_average': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'machine': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['backup.Machine']"}),
            'mem_free': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '3'}),
            'mem_used': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '3'})
        },
