...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScheduleBackup.last_run_time'
        db.alter_column('backup_schedulebackup', 'last_run_time', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'ScheduleBackup.last_run_time'
        db.alter_column('backup_schedulebackup', 'last_run_time', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 28, 11, 49, 19, 829454)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 28, 11, 49, 19, 828796)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
