...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('backup_backup', 'time_ended', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Backup.time_ended'
        db.delete_column('backup_backup', 'time_ended')
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 30, 4, 38, 13, 559085)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'backup.machinestats': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 30, 4, 38, 13, 558441)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
