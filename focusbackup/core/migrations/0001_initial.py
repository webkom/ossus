...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_userprofile', (
            ...
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backup.Company'], blank=True)),
        ))
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['backup.Company']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
