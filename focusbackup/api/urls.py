...
from focusbackup.api.views.client_versions import get_client_versions
...
urlpatterns = patterns('focusbackup.api.views',
    ...
    (r'^machines/(?P<id>\w+)/set_machine_external_ip/(?P<ip_address>[0-9\.]*)$', 'machines.set_machine_external_ip'),
