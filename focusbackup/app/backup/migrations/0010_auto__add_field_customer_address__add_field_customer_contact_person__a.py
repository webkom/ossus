...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('backup_customer', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.contact_person'
        db.add_column('backup_customer', 'contact_person',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.contact_email'
        db.add_column('backup_customer', 'contact_email',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.contact_phone'
        db.add_column('backup_customer', 'contact_phone',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('backup_customer', 'address')

        # Deleting field 'Customer.contact_person'
        db.delete_column('backup_customer', 'contact_person')

        # Deleting field 'Customer.contact_email'
        db.delete_column('backup_customer', 'contact_email')

        # Deleting field 'Customer.contact_phone'
        db.delete_column('backup_customer', 'contact_phone')
    ...
    models = {
        ...
        'backup.machine': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_connection_to_client': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
