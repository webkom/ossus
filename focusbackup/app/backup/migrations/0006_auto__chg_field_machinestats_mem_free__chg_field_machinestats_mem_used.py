...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('backup_machinestats', 'mem_free', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=3))

        # Changing field 'MachineStats.mem_used'
        db.alter_column('backup_machinestats', 'mem_used', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=3))
    ...
    models = {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
