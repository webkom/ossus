...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SQLBackup.type'
        db.alter_column('backup_sqlbackup', 'type', self.gf('django.db.models.fields.CharField')(max_length=40))
    def backwards(self, orm):

        # Changing field 'SQLBackup.type'
        db.alter_column('backup_sqlbackup', 'type', self.gf('django.db.models.fields.TextField')(max_length=40))
    models = {
        'auth.group': {
        ...
        'backup.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
