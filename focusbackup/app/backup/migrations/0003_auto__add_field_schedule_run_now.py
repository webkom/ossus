...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.run_now'
        db.add_column(u'backup_schedule', 'run_now',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Schedule.run_now'
        db.delete_column(u'backup_schedule', 'run_now')
    ...
    models = {
        ...
        u'backup.backup': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Backup'},
        ...
        u'machine.machine': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_connection_to_client': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)', 'null': 'True', 'blank': 'True'}),
