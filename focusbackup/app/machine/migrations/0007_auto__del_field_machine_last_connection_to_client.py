...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Machine.last_connection_to_client'
        db.delete_column(u'machine_machine', 'last_connection_to_client')


    def backwards(self, orm):
        # Adding field 'Machine.last_connection_to_client'
        db.add_column(u'machine_machine', 'last_connection_to_client',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 15, 0, 0), null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'machine.machine': {
            ...
            'lock': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'machine.machineprocessstats': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
