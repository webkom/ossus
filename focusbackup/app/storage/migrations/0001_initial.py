...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'storage_storage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='storages', null=True, to=orm['accounts.Company'])),
        ...
        db.send_create_signal(u'storage', ['Storage'])


    def backwards(self, orm):
        # Deleting model 'Storage'
        db.delete_table(u'storage_storage')
